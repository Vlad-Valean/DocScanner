        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataNasterii = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Domiciliu = table.Column<string>(type: "text", nullable: true),
                    Serie = table.Column<string>(type: "text", nullable: true),
                    Numar = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RomanianIds", x => x.Id);
                });
